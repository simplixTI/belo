    ...
    >
      ...
      <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-5 pb-14 pt-4 sm:gap-14 sm:px-6 sm:pb-20 sm:pt-10 lg:grid-cols-[1.15fr_.85fr] lg:px-10">
        <div className="relative z-10 flex flex-col">
          ...
          >
            A <span className="text-gold-light">BELO'S MUSIC</span> existe para descobrir talentos,
          ...
          >
            ...
            <div className="flex items-center gap-3 text-sm text-ivory/70">
              ...
              <span className="font-sans italic">
                A próxima estrela pode ser <span className="text-gold-light">você</span>.
              </span>
            </div>
          </motion.div>
        </div>
